...
public class JazzyViewPager extends ViewPager {
	...
	private void logState(View v, String title) {
		Log.v(TAG,
				title + ": ROT (" + ViewHelper.getRotation(v) + ", " + ViewHelper.getRotationX(v) + ", " + ViewHelper.getRotationY(v) + "), TRANS ("
						+ ViewHelper.getTranslationX(v) + ", " + ViewHelper.getTranslationY(v) + "), SCALE (" + ViewHelper.getScaleX(v) + ", " + ViewHelper.getScaleY(v)
	...
	private void animateZoom(View left, View right, float positionOffset, boolean in) {
		if (mState != State.IDLE) {
			Log.i("Tag", "in:" + in + ";   positionOffset:" + positionOffset + "   left != null:" + (left != null) + "   right != null:" + (right != null));
			if (left != null) {
				manageLayer(left, true);
